...
def build_continuous_narrative_config() -> dict[str, object]:
    ...
    story = {
        "event": ("L3-E1", "Se marca qué pedidos fueron para llevar.", "Hijo, ¿cuáles sí entran en esa cuenta?", "Primero escribo la regla, Pa.", "Un evento es una condición que cada pedido cumple o no.", "El numerador contiene solo pedidos que cumplen la regla; el denominador conserva el universo."),
        ...
        "standard-error": ("L3-E4", "Se compara la variación del estimador con 8 y 32 noches.", "¿Qué tan nerviosa es esa cuenta?", "No es la variación de cada pedido, Pa.", "El error estándar cuantifica variación esperada de un estimador.", "Aumentar n reduce el error estándar si el muestreo sigue comparable."),
