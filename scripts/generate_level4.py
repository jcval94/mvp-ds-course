...
def config() -> dict[str, object]:
    ...
    specs = [
        ("scatterplot", "Scatterplot", "Construir una nube de puntos para dos variables numéricas.", "Un scatterplot coloca dos variables de la misma observación en ejes perpendiculares.", "posición conjunta punto por punto", "Cada noche ubica pedidos y espera.", "Pon cada noche donde le toca.", "Un punto por noche, apá.", ("Un scatterplot une dos valores de la misma noche.", "La nube muestra relación, grupos y extremos; no demuestra causa."), (statistics.mean(orders), statistics.mean(wait)), (min(orders), max(wait)), "L4-E1", "relaciones@L4.2"),
