...
STORY_CONTRACTS = {
    "mean": ("L2-S01", "Un pedido grande mueve el punto de equilibrio de tacos por pedido.", "Hijo, esa cuenta se fue para arriba. ¿Qué pedido la jaló?", "Déjame comparar antes y después, Pa.", "La media reparte el total por igual entre todos los pedidos.", "Un extremo modifica la media; no vuelve típico ese tamaño."),
    ...
    "mode": ("L2-S03", "Paco cuenta tamaños exactos de pedido.", "Quiero saber cuál se repite más, no cuál queda bonito.", "Voy a contar cada tamaño, Pa.", "La moda es el valor con mayor frecuencia y puede no ser única.", "La frecuencia más alta identifica el tamaño más común de esta entrada."),
    ...
    "standard-deviation": ("L2-S06", "La dispersión vuelve a expresarse en tacos.", "Dime la separación en tacos, no en tacos cuadrados.", "Eso sí se puede contar en la mesa, Pa.", "La desviación estándar es la raíz de la varianza y conserva la unidad original.", "Resume separación respecto de la media; no garantiza una forma normal."),
    ...
    "multimodality": ("L2-S12", "Los minutos del turno revelan dos concentraciones.", "Se nos junta gente dos veces, no una.", "Lo compruebo en los minutos del turno, Pa.", "La multimodalidad aparece con más de una concentración.", "Dos picos sugieren estructura para investigar, no identifican por sí solos la causa."),
