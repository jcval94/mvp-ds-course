...
Revisión de cierre realizada el 15 de junio de 2026:
...
| Práctica | 4 | Dos ejercicios por concepto, evidencia declarada y respuesta bloqueada antes de interactuar |
| Feedback | 5 | Cada opción tiene feedback específico |
| Enseñanza en vivo | 5 | Codex técnico, Gemini/ChatGPT facilitadores, privacidad y plan offline |
...
- `python scripts/qa_pages.py`: 18 conceptos de Nivel 1, 21 conceptos y 42
  ejercicios de Nivel 2, interacciones, prompts y vistas responsive aprobados.
...
- Nivel 1 conserva datasets sintéticos etiquetados.
- Nivel 2 usa snapshots públicos fijos descargados el 14 de junio de 2026.
