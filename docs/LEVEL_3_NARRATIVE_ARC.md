...
- **Historia canónica:** `docs/stories/LEVEL_3.md`.
- **Ledger de entrada:** `L2.4`.
- **Conflicto:** Don Juan quiere aceptar encargos grandes sin confundir una racha favorable con una garantía.
- **Promesa:** razonar con eventos, muestras e incertidumbre antes de convertir el piloto en una decisión permanente.
- **Competencia auxiliar:** declarar incertidumbre, supuestos y comprobaciones de una respuesta asistida.
- **Estado del puesto:** `G2-piloto`; conserva 3 × 2 metros, ocho asientos, un trompo y un comal.
...
| `L3-E5` Una diferencia no es una sentencia | `L3-S15`–`L3-S19` | Don Juan decide mantener el piloto reversible; Paco separa señal de certeza | La familia conserva horarios y límites | `L3.4 → L3.5` | Ninguno |
...
El piloto continúa con reglas reversibles. El subtítulo final abre Nivel 4: **“¿Qué cosas cambian juntas?”**

## Supuestos y límites

- Los 1,360 pedidos son sintéticos, determinísticos y no contienen nombres ni secretos.
