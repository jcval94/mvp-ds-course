...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `L3-S01` | evento | Se marca qué pedidos fueron para llevar | “Hijo, ¿cuáles sí entran en esa cuenta?” | “Primero escribo la regla, Pa.” | Un evento es una condición que cada pedido cumple o no. | El numerador contiene solo pedidos que cumplen la regla; el denominador conserva el universo. | Otra noche usa encargo programado como evento. |
...
- Evaristo debuta como “El Ingeniero”. El espectador sabe que no es ingeniero ni
  experto; su silencio o pregunta literal puede ser sobreinterpretada, pero Paco
