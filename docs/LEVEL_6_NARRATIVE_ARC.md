...
| `L6-E5` Lo que se sabe antes del turno | `L6-S16`–`L6-S18` | Paco revela que solicitó una beca y descubre en privado que Evaristo no es ingeniero; Don Juan respalda el plan sin cargarle el negocio | La plantilla mantiene límites y pago | `L6.5 → L6.6` | Ninguno |
...
- **`evaristoDelta`:** Paco descubre en privado que Evaristo no es ingeniero ni
  experto. No lo revela públicamente, pero impide que su reputación se use como
  firma técnica, autorización o responsable de decisiones.
...
- Evaristo puede preguntar “¿eso lo saben antes?”; Paco verifica disponibilidad
  temporal y el narrador nombra leakage.
