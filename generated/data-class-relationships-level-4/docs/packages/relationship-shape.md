# Paquete: Forma de relación

## Supuestos

- Audiencia adulta principiante; español mexicano cálido.
- Historia aprobada: `docs/stories/LEVEL_4.md`; escena `L4-S03`.
...
- **Objetivo:** Distinguir patrón lineal, curvo y ausencia de patrón.
- **Definición:** La forma describe cómo cambia una variable a través de otra.
- **Intuición:** La visualización hace visible comparación de geometrías antes de resumirlo.
- **Error plausible:** Convertir asociación en causa o ignorar grupos, extremos y denominadores.
- **Mecanismo visual:** comparación de geometrías.
...
1. Se comparan forma lineal, curva y sin patrón.
2. Ejecutar **Revelar forma de relación**.
...
- **Codex:** Verifica una demo reproducible de Forma de relación con el snapshot público, cálculo y aserciones; no inventes filas ni causalidad.
- **Gemini:** Facilita preguntas socráticas sobre Forma de relación; exige predicción, evidencia y límite.
- **ChatGPT:** Revisa precisión y pedagogía de Forma de relación; detecta conclusiones que excedan el diseño.
