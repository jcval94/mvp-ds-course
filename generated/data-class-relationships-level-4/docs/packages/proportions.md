# Paquete: Proporciones

## Supuestos

- Audiencia adulta principiante; español mexicano cálido.
- Historia aprobada: `docs/stories/LEVEL_4.md`; escena `L4-S13`.
...
- **Objetivo:** Comparar eventos usando denominadores explícitos.
- **Definición:** Una proporción divide casos con evento entre el total del grupo.
- **Intuición:** La visualización hace visible numerador sobre denominador antes de resumirlo.
- **Error plausible:** Convertir asociación en causa o ignorar grupos, extremos y denominadores.
- **Mecanismo visual:** numerador sobre denominador.
...
1. Una tabla cruza etapa y alta demanda.
2. Ejecutar **Revelar proporciones**.
...
- **Codex:** Verifica una demo reproducible de Proporciones con el snapshot público, cálculo y aserciones; no inventes filas ni causalidad.
- **Gemini:** Facilita preguntas socráticas sobre Proporciones; exige predicción, evidencia y límite.
- **ChatGPT:** Revisa precisión y pedagogía de Proporciones; detecta conclusiones que excedan el diseño.
