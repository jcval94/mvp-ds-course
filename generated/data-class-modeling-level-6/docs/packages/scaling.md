...
- Historia aprobada: `docs/stories/LEVEL_6.md`; escena `L6-S17`.
...
- **Objetivo:** Centrar y escalar con parámetros guardados.
- **Definición:** Scaling transforma magnitud con parámetros reproducibles.
- **Intuición:** El visual revela centrado y desviación estándar y conserva cada noche observada.
- **Error plausible:** Presentar ajuste en muestra como desempeño futuro, causalidad o decisión automática.
- **Mecanismo visual:** centrado y desviación estándar.
- **Estados:** Entrada documentada → Resultado reproducible.
- **Unidad:** una observación es una noche del puesto.
- **Variables:** inventario_carne_kg estandarizado.
- **Límite:** Ajuste descriptivo dentro de 64 noches; train/test, métricas y generalización pertenecen a Nivel 7.

## LearningModule

1. Inventario se expresa en desviaciones.
2. Ejecutar **Revelar scaling**.
...
- **Codex:** Verifica una demo reproducible de Scaling con el snapshot público, cálculo y aserciones; no inventes filas ni causalidad.
- **Gemini:** Facilita preguntas socráticas sobre Scaling; exige predicción, evidencia y límite.
- **ChatGPT:** Revisa precisión y pedagogía de Scaling; detecta conclusiones que excedan el diseño.
