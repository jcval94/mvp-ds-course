...
- **Concepto anterior:** Poisson.
- **Concepto siguiente:** Sesgo de selección.
...
3. Ejecutar **Tomar muestras** y describir el cambio visible.
...
**Evidencia narrativa común:** Ejecutar «Tomar muestras» y citar el cambio visible asociado con variabilidad muestral.
...
**Pregunta:** ¿Por qué las medias de muestra no son idénticas?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| Porque cada muestra contiene días distintos del mismo snapshot. | Sí | El muestreo cambia qué filas entran al cálculo. |
| Porque la población cambió durante la animación. | No | El snapshot permanece fijo; cambia la selección. |
| Porque el cálculo de media es aleatorio. | No | La fórmula es determinista una vez elegida la muestra. |

**Pista:** Observa qué puntos entran a cada muestra.
...
**Pregunta:** ¿Qué decisión es prudente con una muestra pequeña y muy alta?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| Tratarla como señal provisional y pedir más evidencia. | Sí | Una muestra pequeña puede fluctuar mucho. |
| Cambiar toda la operación del negocio inmediatamente. | No | Una sola muestra extrema no basta para una decisión fuerte. |
| Ignorarla porque ninguna muestra sirve. | No | El muestreo sí informa, pero con incertidumbre. |

**Pista:** Compara la dispersión de medias por tamaño de muestra.
...
**Objetivo docente:** Explicar por qué estimaciones de muestras distintas no coinciden exactamente.
...
**Evaluación rápida:** El estudiante interpreta variabilidad muestral citando evidencia visible, método y limitación.

**Blueprint de demo:** HTML local con snapshot real, botón «Tomar muestras», dos estados visuales y aserción de cambio.
...
> Trabaja como programador docente. Usa el snapshot público indicado y verifica una demo local para «Variabilidad muestral». Objetivo: Explicar por qué estimaciones de muestras distintas no coinciden exactamente. Conserva fuente/licencia/SHA-256 visibles, no inventes filas, etiqueta cualquier simulación como didáctica derivada del snapshot y agrega una comprobación automática del cálculo.

**Gemini**

> Facilita una discusión socrática sobre «Variabilidad muestral». Pide predicción, denominador o hipótesis antes de explicar, cuestiona interpretaciones causales y exige que cada respuesta cite la evidencia visible.

**ChatGPT**

> Actúa como revisor técnico-pedagógico de una clase sobre «Variabilidad muestral». Detecta conclusiones que excedan el diseño, revisa si el feedback corrige errores plausibles y propone dos preguntas de transferencia con respuesta esperada.
