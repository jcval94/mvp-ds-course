...
- **Prerrequisitos:** media, desviación estándar, percentiles y muestreo.
- **Concepto anterior:** Ley de los grandes números.
- **Concepto siguiente:** Intervalo de confianza.
...
3. Ejecutar **Cambiar tamaño de muestra** y describir el cambio visible.
...
**Evidencia narrativa común:** Ejecutar «Cambiar tamaño de muestra» y citar el cambio visible asociado con error estándar.
...
**Historia:** Lucía, consultora que presenta estimaciones a dirección debe comunicar números con incertidumbre sin sonar más segura de lo que los datos permiten. un rango mal explicado puede convertirse en promesa operativa. La decisión es reportar error estándar con el método y sus límites.
...
**Pregunta:** ¿Qué reduce el error estándar de la media?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| Aumentar el tamaño de muestra, si el proceso de muestreo es comparable. | Sí | Más observaciones reducen la variación esperada de la media. |
| Cambiar el color de las barras. | No | El estilo visual no afecta la incertidumbre. |
| Eliminar el reporte de variabilidad. | No | Ocultar variabilidad no la reduce. |

**Pista:** Observa cómo se estrecha la distribución de medias.

### Ejercicio de transferencia

**Historia:** Lucía, consultora que presenta estimaciones a dirección cambia de contexto para probar si el razonamiento se transfiere. un rango mal explicado puede convertirse en promesa operativa. La decisión es reportar error estándar con el método y sus límites.
...
**Pregunta:** ¿Qué diferencia clave hay entre DE y error estándar?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| La DE describe dispersión de individuos; el SE describe dispersión del estimador. | Sí | El visual separa valores individuales de medias muestrales. |
| Son siempre iguales. | No | Solo coinciden en casos especiales, no por definición. |
| El SE mide causalidad. | No | Ninguna de las dos métricas identifica causa por sí sola. |

**Pista:** Mira si la barra representa datos o medias repetidas.
...
**Objetivo docente:** Interpretar el error estándar como variabilidad esperada de una estimación.
...
**Evaluación rápida:** El estudiante interpreta error estándar citando evidencia visible, método y limitación.

**Blueprint de demo:** HTML local con snapshot real, botón «Cambiar tamaño de muestra», dos estados visuales y aserción de cambio.
...
> Trabaja como programador docente. Usa el snapshot público indicado y verifica una demo local para «Error estándar». Objetivo: Interpretar el error estándar como variabilidad esperada de una estimación. Conserva fuente/licencia/SHA-256 visibles, no inventes filas, etiqueta cualquier simulación como didáctica derivada del snapshot y agrega una comprobación automática del cálculo.

**Gemini**

> Facilita una discusión socrática sobre «Error estándar». Pide predicción, denominador o hipótesis antes de explicar, cuestiona interpretaciones causales y exige que cada respuesta cite la evidencia visible.

**ChatGPT**

> Actúa como revisor técnico-pedagógico de una clase sobre «Error estándar». Detecta conclusiones que excedan el diseño, revisa si el feedback corrige errores plausibles y propone dos preguntas de transferencia con respuesta esperada.
