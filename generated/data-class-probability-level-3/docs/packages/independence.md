...
- **Concepto anterior:** Complemento.
- **Concepto siguiente:** Probabilidad condicional.
...
3. Ejecutar **Comparar tasas** y describir el cambio visible.
...
**Evidencia narrativa común:** Ejecutar «Comparar tasas» y citar el cambio visible asociado con independencia.
...
**Historia:** Ana, coordinadora de admisiones de un acuario debe explicar probabilidades de especies e islas sin confundir subconjuntos. si usa el denominador incorrecto, el reporte público dará una proporción engañosa. La decisión es elegir la lectura de independencia que conserva el universo correcto.
...
**Pregunta:** ¿Qué evidencia contradice independencia entre especie e isla?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| La tasa condicionada por isla cambia respecto de la tasa global. | Sí | Si condicionar cambia mucho la probabilidad, no parece independencia. |
| Las islas tienen nombres diferentes. | No | Los nombres no prueban relación probabilística. |
| Hay más de una especie en el dataset. | No | La diversidad de categorías no basta para decidir. |

**Pista:** Compara la barra global con la barra condicionada.

### Ejercicio de transferencia

**Historia:** Ana, coordinadora de admisiones de un acuario cambia de contexto para probar si el razonamiento se transfiere. si usa el denominador incorrecto, el reporte público dará una proporción engañosa. La decisión es elegir la lectura de independencia que conserva el universo correcto.
...
**Pregunta:** ¿Qué conclusión prudente permite la comparación?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| En este snapshot, isla y especie no se comportan como independientes. | Sí | La evidencia describe asociación probabilística en el snapshot. |
| La isla causa la especie. | No | El diseño observacional no identifica causa. |
| La independencia siempre falla en datos biológicos. | No | No se puede universalizar a todo dataset. |

**Pista:** Distingue asociación de causalidad.
...
**Objetivo docente:** Comparar probabilidades marginales y condicionadas para evaluar independencia.
...
**Evaluación rápida:** El estudiante interpreta independencia citando evidencia visible, método y limitación.

**Blueprint de demo:** HTML local con snapshot real, botón «Comparar tasas», dos estados visuales y aserción de cambio.
...
> Trabaja como programador docente. Usa el snapshot público indicado y verifica una demo local para «Independencia». Objetivo: Comparar probabilidades marginales y condicionadas para evaluar independencia. Conserva fuente/licencia/SHA-256 visibles, no inventes filas, etiqueta cualquier simulación como didáctica derivada del snapshot y agrega una comprobación automática del cálculo.

**Gemini**

> Facilita una discusión socrática sobre «Independencia». Pide predicción, denominador o hipótesis antes de explicar, cuestiona interpretaciones causales y exige que cada respuesta cite la evidencia visible.

**ChatGPT**

> Actúa como revisor técnico-pedagógico de una clase sobre «Independencia». Detecta conclusiones que excedan el diseño, revisa si el feedback corrige errores plausibles y propone dos preguntas de transferencia con respuesta esperada.
