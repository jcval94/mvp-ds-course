...
- **Concepto anterior:** Evento.
- **Concepto siguiente:** Independencia.
...
3. Ejecutar **Mostrar complemento** y describir el cambio visible.
...
**Evidencia narrativa común:** Ejecutar «Mostrar complemento» y citar el cambio visible asociado con complemento.
...
**Historia:** Ana, coordinadora de admisiones de un acuario debe explicar probabilidades de especies e islas sin confundir subconjuntos. si usa el denominador incorrecto, el reporte público dará una proporción engañosa. La decisión es elegir la lectura de complemento que conserva el universo correcto.
...
**Pregunta:** Si el evento es 'Adelie', ¿qué representa el complemento?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| Todos los pingüinos que no son Adelie. | Sí | El complemento contiene todos los casos fuera del evento original. |
| Solo los Adelie de otra isla. | No | Cambiar isla introduce otra condición distinta. |
| Una muestra nueva inventada. | No | No se crean filas; se reclasifican las existentes. |

**Pista:** Evento y complemento deben sumar el total.

### Ejercicio de transferencia

**Historia:** Ana, coordinadora de admisiones de un acuario cambia de contexto para probar si el razonamiento se transfiere. si usa el denominador incorrecto, el reporte público dará una proporción engañosa. La decisión es elegir la lectura de complemento que conserva el universo correcto.
...
**Pregunta:** ¿Qué debe cumplirse para usar P(no A) = 1 - P(A)?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| Que A y no A cubran todos los resultados sin traslape. | Sí | La regla funciona porque evento y complemento forman una partición. |
| Que A tenga más casos que no A. | No | El tamaño relativo no invalida la identidad. |
| Que A sea causalmente importante. | No | La identidad no habla de causalidad. |

**Pista:** Revisa si alguna fila queda fuera de ambas categorías.
...
**Objetivo docente:** Interpretar el complemento como todo lo que no pertenece al evento.
...
**Evaluación rápida:** El estudiante interpreta complemento citando evidencia visible, método y limitación.

**Blueprint de demo:** HTML local con snapshot real, botón «Mostrar complemento», dos estados visuales y aserción de cambio.
...
> Trabaja como programador docente. Usa el snapshot público indicado y verifica una demo local para «Complemento». Objetivo: Interpretar el complemento como todo lo que no pertenece al evento. Conserva fuente/licencia/SHA-256 visibles, no inventes filas, etiqueta cualquier simulación como didáctica derivada del snapshot y agrega una comprobación automática del cálculo.

**Gemini**

> Facilita una discusión socrática sobre «Complemento». Pide predicción, denominador o hipótesis antes de explicar, cuestiona interpretaciones causales y exige que cada respuesta cite la evidencia visible.

**ChatGPT**

> Actúa como revisor técnico-pedagógico de una clase sobre «Complemento». Detecta conclusiones que excedan el diseño, revisa si el feedback corrige errores plausibles y propone dos preguntas de transferencia con respuesta esperada.
