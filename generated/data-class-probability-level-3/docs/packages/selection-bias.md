...
- **Concepto anterior:** Variabilidad muestral.
- **Concepto siguiente:** Ley de los grandes números.
...
3. Ejecutar **Comparar muestra sesgada** y describir el cambio visible.
...
**Evidencia narrativa común:** Ejecutar «Comparar muestra sesgada» y citar el cambio visible asociado con sesgo de selección.
...
**Pregunta:** ¿Qué evidencia indica sesgo de selección?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| La muestra filtrada tiene una media distinta porque excluye parte del año. | Sí | El filtro cambia sistemáticamente qué casos entran. |
| La muestra contiene muchas filas. | No | Tamaño grande no garantiza representatividad. |
| El gráfico tiene barras del mismo color. | No | El color no define el sesgo. |

**Pista:** Compara el proceso de selección, no solo el tamaño.
...
**Pregunta:** ¿Qué debe reportarse junto con una estimación de muestra sesgada?

| Opción | Correcta | Feedback |
| --- | --- | --- |
| La regla de selección y el límite de generalización. | Sí | La regla de inclusión explica a quién representa la muestra. |
| Solo el promedio final. | No | El promedio sin proceso de selección oculta el sesgo. |
| Una afirmación causal sobre la temporada. | No | El filtro no prueba causalidad estacional. |

**Pista:** Busca el aviso de universo observado.
...
**Objetivo docente:** Detectar cuándo el proceso de selección cambia el grupo observado.
...
**Evaluación rápida:** El estudiante interpreta sesgo de selección citando evidencia visible, método y limitación.

**Blueprint de demo:** HTML local con snapshot real, botón «Comparar muestra sesgada», dos estados visuales y aserción de cambio.
...
> Trabaja como programador docente. Usa el snapshot público indicado y verifica una demo local para «Sesgo de selección». Objetivo: Detectar cuándo el proceso de selección cambia el grupo observado. Conserva fuente/licencia/SHA-256 visibles, no inventes filas, etiqueta cualquier simulación como didáctica derivada del snapshot y agrega una comprobación automática del cálculo.

**Gemini**

> Facilita una discusión socrática sobre «Sesgo de selección». Pide predicción, denominador o hipótesis antes de explicar, cuestiona interpretaciones causales y exige que cada respuesta cite la evidencia visible.

**ChatGPT**

> Actúa como revisor técnico-pedagógico de una clase sobre «Sesgo de selección». Detecta conclusiones que excedan el diseño, revisa si el feedback corrige errores plausibles y propone dos preguntas de transferencia con respuesta esperada.
